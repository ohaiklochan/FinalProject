...
# 2nd Choice
Choice.create(prompt: "You notice that the lights are flashing above you. You brush it off as nothing.", choiceA: "Direct Cassandra to go to the elevator first.", choiceB: "You go into the elevator first.", turn: 2, path: "left", ending: "Good", from: "Notice the flashing lights of the floor")
...
# 5th Choice
Choice.create(prompt: "You hastily walk inside before Cassandra and she follows you inside. You push the button to the garage floor.", choiceA: "Notice that the light is flickering in the elevator.", choiceB: "Notice the time.", turn: 3, path: "right", ending: "Bad", from: "You go into the elevator first.")
...
# 7th
Choice.create(prompt: "You look at your watch. 11:48pm. ‘Ugh,’ you think to yourself. It’s so late. I should have been home by now. Suddenly, the lights turn off.", choiceA: "Call out for Cassandra.", choiceB: "Grab your phone and take out the flashlight.", turn: 4, path: "right", ending: "Bad", from: "Notice the time.")
...
# 30
Choice.create(prompt: "You decide to get ready for bed. It’s pretty late anyway. You go to the bathroom and start to brush your teeth. You hear a bump at the window. A quick chill rushes down your back. Something catches your peripheral vision.", choiceA: "Look what’s outside your window", choiceB: "Walk away from the window", turn: 16, path: "left", ending: "Good", from: "Brush your teeth")

# 31
Choice.create(prompt: "You decide to get ready for bed. It’s pretty late anyway. You go to your bedroom and change into your pajamas.You hear a bump at the window. A quick chill rushes down your back. Something catches your peripheral vision.", choiceA: "Look what’s outside your window", choiceB: "Walk away from the window", turn: 16, path: "right", ending: "Bad", from: "Get your pajamas on")
...
# 34
Choice.create(prompt: "You feel the need to protect yourself - so you run to the kitchen and grab a knife. You look all around you - you’re highly aware, on edge, and shaking. You run back to your bedroom.", choiceA: "Lock your door", choiceB: "Lock your window", turn: 18, path: "left", ending: "Good", from: "Go to the kitchen and grab a knife")
...
# 38
Choice.create(prompt: "It was a rough night, but you made it. The alarm goes off. 6:00AM. You slowly walk up to your door and turn the handle. You open the door a crack and look out in the hallway. Nothing. It is silent. You open your door a little more and walk out, still looking around. Nothing. Silence. You walk around your house. You just hear the creak of the floors under your feet. Everything is calm and brightly lit. You take a sigh of relief and relax your shoulders. You go to the bathroom and close the door to use the toilet. You see the shower curtain start moving… Good Ending.", choiceA: "Restart", choiceB: "End Game", turn: 20, path: "left", ending: "Good", from: "Stay up")
